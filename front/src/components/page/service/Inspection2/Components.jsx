...
const Inspection2Component = () => {
  return (
    <>
      <Inspection2Content>
        <div className="Inspection2ContentItem1">
          <Inspection2ItemBox1>
            <div>
              <span className="FontB">Inspection2</span>
...
const Inspection2ItemBox1 = styled.div`
...
`;
const Inspection2ItemBox2 = styled.div`
...
const Inspection2ItemTextRow = styled.div`
  display: flex;
  justify-content: flex-start;
  align-items: flex-start;
  flex-direction: row;
...
`;
const Inspection2ItemTextCol = styled.div`
  display: flex;
  justify-content: flex-start;
  align-items: flex-start;
  text-align: left;

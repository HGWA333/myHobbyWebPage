    ...
    <>
      <ServiceContent>
        <div className="ServiceContentItem1">
          <ServiceItemBox1 className="BorderB">
            <div>
                  ...
                  <>
                    <ServiceItemBox2>
                      <div className="FlexM PaddingL">
                        ...
                        <span className="FontLs BackGroundC">건설현장 정기안전점검</span>
                      </div>
                      <div className="FlexCol ">
                        <ServiceItemTextCol className="MarginT">
                  ...
                  <>
                    <ServiceItemBox2>
                      <div className="FlexM PaddingL">
                        ...
                        <span className="FontLs BackGroundC">건축물 정기안전점검</span>
                      </div>
                      <div className="FlexCol ">
                        <ServiceItemTextCol className="MarginT">
                          <span className="Stext PaddingR">
                  ...
                  <>
                    <ServiceItemBox2>
                      <div className="FlexM PaddingL">
                        ...
                        <span className="FontLs BackGroundC">빌드업 안심서비스</span>
                      </div>
                      <div className="FlexCol ">
                        <ServiceItemTextCol className="MarginT">
                          <span className="Stext PaddingR">
                  ...
                  <>
                    <ServiceItemBox2>
                      <div className="FlexM PaddingL">
                        ...
                        <span className="FontLs BackGroundC">건축물 하자진단</span>
                      </div>
                      <div className="FlexCol">
                        <ServiceItemTextCol className="MarginT">
                          <span className="Stext PaddingR">
                  ...
                  <>
                    <ServiceItemBox2>
                      <div className="FlexM PaddingL">
                        ...
                        <span className="FontLs BackGroundC">법원감정</span>
                      </div>
                      <div className="FlexCol ">
                        <ServiceItemTextCol className="MarginT">
                          <span className="Stext PaddingR">

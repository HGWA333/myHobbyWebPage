    ...
    <>
      <DiagnosisContent>
        <div className="DiagnosisContentItem1">
          <DiagnosisItemBox1>
            <div>
              <span className="FontB">Diagnosis</span>
...
const DiagnosisItemBox1 = styled.div`
...
`;
const DiagnosisItemBox2 = styled.div`
...
const DiagnosisItemTextRow = styled.div`
  display: flex;
  justify-content: flex-start;
  align-items: flex-start;
  flex-direction: row;
...
`;
const DiagnosisItemTextCol = styled.div`
  display: flex;
  justify-content: flex-start;
  align-items: flex-start;
  text-align: left;
